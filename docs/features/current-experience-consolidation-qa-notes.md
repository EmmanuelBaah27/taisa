...
- Follow-up device QA showed hard rectangular edges still crossing the close and recording-control shadows. The remaining cause was the page-wide horizontal gutter constraining the header fade and composer gradient. Those painted backgrounds are now full-bleed, while their controls and conversation content retain the same 20px inner gutter.
