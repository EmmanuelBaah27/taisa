...
| `VoiceReactiveTimestamp` | `durationSeconds`, `amplitude`, `paused` | Figma node 409:4850 compact 60×56 timer glow. Voice-gated two-second mustard/purple/green stagger with fast attack, eased release, and a static paused state. |
